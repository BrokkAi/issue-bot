...
func (c Config) Validate() error {
	...
	for _, pair := range [][2]string{{c.Directory, c.StateDirectory}, {c.StateDirectory, c.Directory}, {c.Directory + "-issues", c.StateDirectory}, {c.StateDirectory, c.Directory + "-issues"}} {
